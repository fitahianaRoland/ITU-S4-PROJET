                ...
                <div class="col-12 col-lg-8">
                    <div class="intro-news-tab">
                        ...
                        <div class="intro-news-filter d-flex justify-content-between">
                            <h6>pour modifier votre regime</h6>
                            <nav>
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                                <div class="wrapper">
                                                    <h2>modifier</h2>
                                                    <form action="<?php echo base_url('Traitement/insertupdate'); ?>">
                                                      <div class="input-box">
                                                        <label for="">nom</label>
                                                        <input type="text" name="nom" value="<?php echo $idplat[0]['nomplat']; ?>" required>
                                                      </div>
                                                      <label for="">prix</label>
                                                      <div class="input-box">
                                                        <input type="text" name="prix" value="<?php echo $idplat[0]['prix']; ?>" required>
                                                      </div>
                                                      <label for="">calori</label>
                                                      <div class="input-box">
                                                        <input type="number" name="calori" value="<?php echo $idplat[0]['gain']; ?>" required>
                                                      </div>
                                                      <label for="">durrer jour</label>
                                                      <div class="input-box">
                                                        <input type="number" name="date" value="<?php echo $idplat[0]['dureejour']; ?>" required>
                                                      </div>
